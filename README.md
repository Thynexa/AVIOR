...
[![Status](https://img.shields.io/badge/status-design%20phase-yellow)](./AVIOR%20PRD.md)
[![License](https://img.shields.io/badge/license-Apache--2.0-blue)](#license--许可)
[![Language](https://img.shields.io/badge/implementation-R%20%E2%89%A5%204.1-276DC3)](./AVIOR%20PRD.md)
[![PRD](https://img.shields.io/badge/PRD-v1.2-informational)](./AVIOR%20PRD.md)
...
>
> The development baseline is [`AVIOR PRD.md`](./AVIOR%20PRD.md) (v1.2) — all future work is scoped against it, and revisions go through pull requests.
...
```text
AVIOR/
├── AVIOR PRD.md                    # ⭐ Development baseline: PRD v1.2
├── ValiR PRD.md                    # Historical reference: platform-shaped PRD v0.1, superseded
├── 评审意见与聚焦规划.md            # Review notes: platform → CLI-tool scope narrowing
├── R语言合规递交调研与实施方案.md   # Methodology research: regulatory requirements & tool comparison
├── R包验证策略分析与实施方案.docx   # Same, docx version
├── examples/
...
| --- | --- |
| Looking for the full product picture | [`AVIOR PRD.md`](./AVIOR%20PRD.md) — positioning, axioms, CLI, file contracts, milestones |
...
| Interested in the methodology | [`R语言合规递交调研与实施方案.md`](./R语言合规递交调研与实施方案.md) — regulatory background and tool-chain comparison |
| Curious why the scope is what it is | [`评审意见与聚焦规划.md`](./评审意见与聚焦规划.md) — the reasoning behind narrowing from a platform to a CLI tool |
